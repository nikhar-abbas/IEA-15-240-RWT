...
# Setup paths
openfast_call = 'openfast_master'
model_path = os.path.join(os.getcwd(), 'IEA-15-240-RWT', 'OpenFAST', 'IEA-15-240-RWT-Monopile')
...
turb.load_from_fast(path_params['FAST_InputFile'], path_params['FAST_directory'], rot_source='txt',
                    txt_filename=path_params['rotor_performance_filename'], dev_branch=True)
# turb.load_from_fast(path_params['FAST_InputFile'], path_params['FAST_directory'])
